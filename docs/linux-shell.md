...
anyone only touching the Android side, and makes opting into the
native shell a deliberate step once that toolchain is actually
installed — the same way a project would opt in to any platform
target with real system dependencies.
