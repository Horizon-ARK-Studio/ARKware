...
| [`cli-reference.md`](./cli-reference.md) | Every command and flag for `arkware-shell`, `arkware-spa`, and `arkware-linux` |
...
| [`linux-shell.md`](./linux-shell.md) | `arkware-linux`: building main's real native C shell (GTK + WebKitGTK), not Neutralino |
